...
<input type="text" id="edit_file_name">
  ...
  <div class="form-group mb-3">
    <label for="">Name</label>
      <input type="text" id="edit_name"class="name form-control" placeholder="Название файла">
      
    </div>
  <!--<div class="form-group mb-3">
    <label for="">Date</label>
      <input type="text" id="edit_date" class="date form-control" placeholder="Дата">
  </div>
  <div class="form-group mb-3">
    <label for="">Description</label>
      <input type="text" id="edit_description" class="description form-control" placeholder="Описание">
    </form>
  </div> -->
  <div class="modal-footer">
